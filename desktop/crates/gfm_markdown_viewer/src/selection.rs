...
use crate::constants::*;
use crate::gfm_markdown_viewer::{collect_indentation_dot_indices, LinkHandlerFn};
use crate::types::*;
        ...
        window.on_mouse_event({
            ...
            move |event: &MouseUpEvent, phase, window, cx| {
                ...
                if updated.range.is_empty() {
                    ...
                    selection_text(&render_state, text_id, &text_for_selection)
                {
...
pub(crate) fn selection_state_for(
