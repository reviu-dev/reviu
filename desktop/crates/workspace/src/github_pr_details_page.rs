...
mod tests {
  ...
  use super::*;
  use crate::api::{
    GithubPullRequestCheckRun, GithubPullRequestChecksRollupState, GithubPullRequestLegacyStatus,
    GithubPullRequestMergeMethod, GithubPullRequestMergeReadinessStatus, GithubPullRequestReview,
    GithubPullRequestReviewState, GithubPullRequestReviewUser, GithubPullRequestWorkflowJob,
