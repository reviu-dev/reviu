...
use crate::pull_request_checks::{
  CheckRow, check_app_initial, check_rows, checks_summary_subtitle, checks_summary_title,
...
impl GithubPrDetailsPage {
  ...
  pub(super) fn render_overview_checks_summary_icon(
    ...
    let center_icon = checks_uniform_state(checks).map(|state| match state {
