...
impl IconNamed for UiIconName {
  fn path(self) -> SharedString {
    match self {
      ...
      UiIconName::ArrowUp => "icons/arrow-up.svg",
      UiIconName::Maximize2 => "icons/maximize-2.svg",
      UiIconName::Minimize2 => "icons/minimize-2.svg",
      UiIconName::Stop => "icons/stop.svg",
      ...
      UiIconName::TextWrap => "icons/text-wrap.svg",
      UiIconName::FileX => "icons/file-x.svg",
      ...
      UiIconName::DiffInline => "icons/diff-inline.svg",
      UiIconName::DiffSplit => "icons/diff-split.svg",
      UiIconName::Pin => "icons/pin.svg",
      UiIconName::Terminal => "icons/terminal.svg",
      UiIconName::X => "icons/x.svg",
      UiIconName::Eye => "icons/eye.svg",
      UiIconName::Pilcrow => "icons/pilcrow.svg",
      ...
      UiIconName::Archive => "icons/archive.svg",
      UiIconName::ArchiveRestore => "icons/archive-restore.svg",
      ...
      UiIconName::Brain => "icons/brain.svg",
      UiIconName::BookOpen => "icons/book-open.svg",
      UiIconName::Search => "icons/search.svg",
      UiIconName::Replace => "icons/replace.svg",
      UiIconName::ReplaceAll => "icons/replace-all.svg",
      UiIconName::Globe => "icons/globe.svg",
      UiIconName::FolderPlus => "icons/folder-plus.svg",
      ...
      UiIconName::Pi => "icons/brands/pi.svg",
    }
    .into()
  }
}
